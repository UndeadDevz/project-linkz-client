...
export function SortableItem(props: ILinkProps) {
  ...
  return (
    <div
      ...
      } h-40 my-4 bg-white rounded-xl shadow-sm shadow-gray-400 flex overflow-hidden justify-center font-nunito`}
    >
      {props.id === "title" ? (
      ...
      <div
        className={`grow flex flex-col overflow-auto p-2 ${
          props.type === "link" ? "justify-center gap-1" : "justify-center"
        }`}
      >
