  ...
  return (
    <>
      <div
        ...
        className="w-full h-16 text-xl bg-red-700 rounded-lg text-center cursor-pointer hover:bg-red-800 text-white justify-center flex flex-col items-center"
      >
        <FaLink />
      ...
      {showModal && (
        <div
          ref={divRef}
          className="absolute w-fit top-[20%] left-[40%] bg-gray-100 px-8 py-4 rounded-lg z-10 shadow-sm shadow-black font-nunito"
        >
          <div
