  ...
  return (
    <>
      <div
        ...
        className="w-full h-16 p-2 text-md bg-blue-700 hover:bg-blue-800 rounded-lg text-center text-white justify-center flex flex-col items-center cursor-pointer"
      >
        <BsTextareaResize />
        <div>Edit Title</div>
      </div>
